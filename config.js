...
module.exports = kconfig = async (kill, message) => {
	...
	const chats = (type === 'chat') ? body : (type === 'image' || type === 'video') ? caption : ''
        const ownerNumber = '51916659000@c.us' // MUDE ISSO PARA O SEU NUMERO
				...
				case 'play':
					...
					.then(async (res) => {
						...
						if (afsize >= 16.0 || asize.data.filesize.endsWith('GB')) {
							...
							await kill.sendFileFromUrl(from, `${res.data[0].thumbnail}`, ``, `*࿃⃟࿃⃟⚊⚊⚊░⁔⃞🔊⃞⁔░⚊⚊⚊⃟࿃⃟࿃*\n\n*▒⃟⃚⁐⃪ Titulo:* ${res.data[0].title}\n\n*▒⃟⃚⁐⃪ Duración:* ${res.data[0].duration} segundos\n\n*▒⃟⃚⁐⃪ Está hecho:* ${playre}\n\n*▒⃟⃚⁐⃪ Visualizaciones:* ${res.data[0].viewCount}\n\n*「 Espero que este bien 」*\n\n*『 Solo tiene que esperar a que termine de enviar el archivo⎙ para volver a usarlo』*`, id)
	...
	case 'date':
		...
		case 'ship':
			...
			case 'gay':
				...
				if (args.length == 1) {
					await kill.sendTextWithMentions(from, gaak[1] + ' es ' + lvpc + '% ' + guei + '.')
				} else {
			...
			await kill.reply(from, `_De acuerdo con mis cálculos súper avanzados de robot la oportunidad de..._ \n\n*"${body.slice(8)}"*\n\n_...es en realidad del_ *${lvpc}%.*`, id)
			break
			...
			case 'kiss':
				...
				if (args.length == 1) {
					...
					if (octo == 1) {
					await kill.sendGiphyAsSticker(from, 'https://media.giphy.com/media/vcJA8zKCK8990aOHaF/giphy.gif')
					} else if (octo == 2) {
					await kill.sendGiphyAsSticker(from, 'https://media.giphy.com/media/sWrVsUCAHbVKdRw8Q9/giphy.gif')
					} else if (octo == 3) {
					await kill.sendGiphyAsSticker(from, 'https://media.giphy.com/media/NIxz7RvSDLI7yZoFYa/giphy.gif')
					} else if (octo == 4) {
					await kill.sendGiphyAsSticker(from, 'https://media.giphy.com/media/NLSNBtL6bKu1Mtw4K9/giphy.gif')
					} else if (octo == 5) {
					await kill.sendGiphyAsSticker(from, 'https://media.giphy.com/media/VITXBfifXD0HtJ7Xmc/giphy.gif')
					} else if (octo == 6) {
					await kill.sendGiphyAsSticker(from, 'https://media.giphy.com/media/sWrVsUCAHbVKdRw8Q9/giphy.gif')
					} else if (octo == 7) {
					await kill.sendGiphyAsSticker(from, 'https://media.giphy.com/media/NIxz7RvSDLI7yZoFYa/giphy.gif')
					} else {
					await kill.sendGiphyAsSticker(from, 'https://media.giphy.com/media/f7G2Xniw3PrSP0ymDd/giphy.gif')	
					}
				} else {
				...
				case 'slap':
					...
					kill.sendTextWithMentions(from, '@' + person + ' *abofetea a* ' + arq[1])
						if (octo == 1) {
						await kill.sendGiphyAsSticker(from, 'https://media.giphy.com/media/vOVmuXoIXRUm1AGttg/giphy.gif')
						} else if (octo == 2) {
						await kill.sendGiphyAsSticker(from, 'https://media.giphy.com/media/Ee0lSe31cx0HFCM00O/giphy.gif')
						} else if (octo == 3) {
						await kill.sendGiphyAsSticker(from, 'https://media.giphy.com/media/oKGdMJMEhQhrHs22oO/giphy.gif')
						} else if (octo == 4) {
						await kill.sendGiphyAsSticker(from, 'https://media.giphy.com/media/HnDJWIFmASu9X1B0qC/giphy.gif')
						} else if (octo == 5) {
						await kill.sendGiphyAsSticker(from, 'https://media.giphy.com/media/KpQiMCttlLaJtFucq7/giphy.gif')
						} else if (octo == 6) {
						await kill.sendGiphyAsSticker(from, 'https://media.giphy.com/media/C0uVxLqaZctjdHaTYz/giphy.gif')
						} else if (octo == 7) {
						await kill.sendGiphyAsSticker(from, 'https://media.giphy.com/media/Flws2eLbL910cfhfvL/giphy.gif')
						} else {
						await kill.sendGiphyAsSticker(from, 'https://media.giphy.com/media/Ee0lSe31cx0HFCM00O/giphy.gif')	
						}
				...
				case 'hugging':
						arqa = body.trim().split(' ')
								if (args.length == 1) {
									const persona = author.replace('@c.us', '')
									kill.sendTextWithMentions(from, '@' + persona + ' abraza a ' + arqa[1] + ' !')
									if (octo == 1) {
									await kill.sendGiphyAsSticker(from, 'https://media.giphy.com/media/dN6TAEv4vFeIO1dIRN/giphy.gif')
									} else if (octo == 2) {
									await kill.sendGiphyAsSticker(from, 'https://media.giphy.com/media/5EK3cvhW4Pw3bnAUWN/giphy.gif')
									} else if (octo == 3) {
									await kill.sendGiphyAsSticker(from, 'https://media.giphy.com/media/CjlZ7wYAknJHIApLph/giphy.gif')
									} else if (octo == 4) {
									await kill.sendGiphyAsSticker(from, 'https://media.giphy.com/media/rzChSeiUuOu8t6fZvt/giphy.gif')
									} else if (octo == 5) {
									await kill.sendGiphyAsSticker(from, 'https://media.giphy.com/media/INR5S7JQMZSSJD0yAr/giphy.gif')
									} else if (octo == 6) {
									await kill.sendGiphyAsSticker(from, 'https://media.giphy.com/media/sWrVsUCAHbVKdRw8Q9/giphy.gif')
									} else if (octo == 7) {
									await kill.sendGiphyAsSticker(from, 'https://media.giphy.com/media/Xfwr9kRDMHejdznYwa/giphy.gif')
									} else {
									await kill.sendGiphyAsSticker(from, 'https://media.giphy.com/media/Xfwr9kRDMHejdznYwa/giphy.gif')	
									}
								} else {
									await kill.reply(from, 'Marque ~ solo una ~ la persona a la que quiere abrazar', id)
								}
			     	break
		...
		case 'menu':
				...
				const allin = `┏━᷌━᷌━᷌━᷌━᷌━᷌━᷌━᷌━⃟⟦⃞✓⃞⟧⃟━━᷌━᷌━᷌━᷌━᷌━᷌━᷌━᷌┓\n Hola usuario "@${sender.id}"!\n┯⃪━⃪᤻━⃪᤻━⃪᤻━⃪᤻━⃪᤻━⃪᤻━⃪᤻━⃪᤻❐⃟࿃⃟❐⃪━⃪᤻━⃪᤻━⃪᤻━⃪᤻━⃪᤻━⃪᤻━⃪᤻━⃪᤻┯\n\nMe lleve ${processTime(t, moment())} segundos para responder.\n\nTIEMPO EXACTO\n*▒⃪⟦  "${timed}"  ⟧▒*.\n\n`
				kill.sendTextWithMentions(from, allin + help, id)
				kill.reply(from, 'ೋ❀❀ೋ═══ • ═══ೋ❀❀ೋ\n\n      MƛƧ ƇƠMƛƝƊƠƧ\n\n*▒⟧⃟	<	 /Admins* sólo admins\n\n*▒⟧⃟	<	 /Kill* para el propietario\n\n*▒⟧⃟	<	 /Adult* menú de adultos\n\n*▒⟧⃟	<	 /Down* menu de descargas', id)
				break
		...
		case 'funmenu':
			kill.reply(from,`┏━━━━━━━━━━━━━━━━━━━━┓\n┃╭───────────────────\n┃│➸ */chance <texto>*\n┃│❐ _probabilidad de que suceda_\n┃│➸ */death <nombre>*\n┃│❐ _a qué edad muere esa persona_\n┃│➸ */gay @persona*\n┃│❐ _qué orientación sexual es_\n┃│➸ */ship @persona @persona*\n┃│❐ _shipeo entre miembros_\n┃│➸ */kiss @persona*\n┃│❐ _besos_ jsjsj \n┃│➸ */slap @persona*\n┃│❐ _golpea a alguien_ :v\n┃│➸ */store <nombre>*\n┃│❐ _información de una app_\n┃│➸ */happymod <app>*\n┃│❐ _link de descarga_\n┃│ _gratis de una app_\n┃╰───────────────────\n┗━━━━━━━━━━━━━━━━━━━━┛`, id)
			break
        case 'adult':
		...
		case 'animemenu':
			kill.reply(from,`┏━━━━━━━━━━━━━━━━━━━━┓\n┃╭───────────────────\n┃│➸ */loli*\n┃│❐ _Imagen de loli_\n┃│➸ */waifu*\n┃│❐ _imagen de wiafu_\n┃│➸ */neko*\n┃│❐ _neko anime_\n┃│➸ */RandomAnime*\n┃│❐ _imagen anime aleatoria_\n┃│➸ */yuri*\n┃│❐ _imagen Yuri_\n┃│➸ */yaoi*\n┃│❐ _imagen yaoi_\n┃│➸ */anime <nombre>*\n┃│❐ _Busca ub anime por el nombre_\n┃│➸ */cocegas*\n┃│❐ _imagen de cosquillas_\n┃│➸ */poke*\n┃│❐ _poke_ :v\n┃│➸ */cafune*\n┃│❐ _a quién no le gusta cafune_\n┃│➸ */kisu*\n┃│❐ _imagen de beso_\n┃│➸ */tapa*\n┃│❐ _imagen de patas_\n┃│➸ */truth*\n┃│❐ _verdades sobre el anime_\n┃│➸ */icon* \n┃│❐ _imagen anime de perfil_\n┃│➸ */holo*\n┃│❐ _imagen de personaje anime_\n┃│➸ */image <nombre>*\n┃│❐ _imagen_\n┃│➸ */search +imagen*\n┃│❐ _busca el name del anime\n┃│por una imagen_\n┃│➸ */face*\n┃│❐ _perfil de chica anime_\n┃│➸ */baka*\n┃│❐ _baka xd_\n┃╰───────────────────\n┗━━━━━━━━━━━━━━━━━━━━┛`,id) 
		    break

		case 'animalmenu':
			kill.reply(from,`┏━━━━━━━━━━━━━━━━━━━━┓\n┃╭───────────────────\n┃│➸ */fox*\n┃│❐ _Imagen de zorro_\n┃│➸ */goat*\n┃│❐ _imagen de cabras_\n┃│➸ */gato*\n┃│❐ _imagen de gato_\n┃│➸ */macaco*\n┃│❐ _imagen de monos_\n┃│➸ */imagen <nombre>*\n┃│❐ _imagen de que tu quieras_\n┃│➸ */quack*\n┃│❐ _patos_\n┃╰───────────────────\n┗━━━━━━━━━━━━━━━━━━━━┛` , id)
	        break

		case 'markermenu':
			kill.reply(from,`┏━━━━━━━━━━━━━━━━━━━━┓\n┃╭───────────────────\n┃│➸ */sticker*\n┃│❐ _Imagen a sticker_\n┃│➸ */meme <arriba | abajo>*\n┃│❐ _creador de meme, _\n┃│➸ */make*\n┃│❐ _escribe un diario_\n┃│➸ */giphy <enlace giphy>*\n┃│❐ _sticker animado a través\n┃│ de un enlace_\n┃│➸ */invertir <frase>*\n┃│❐ _invierte el orden del texto_\n┃│➸ */contar*\n┃│❐ _cuenta el número de letras_\n┃╰───────────────────\n┗━━━━━━━━━━━━━━━━━━━━┛`, id)
		    break	
